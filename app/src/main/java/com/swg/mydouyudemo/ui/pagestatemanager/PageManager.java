...
public class PageManager {
    ...
    public static int NO_LAYOUT_ID = 0;
    ...
    public PageManager(Object activityOrFragmentOrView, PageListener listener) {
        ...
        } else if (activityOrFragmentOrView instanceof FrameLayout) {
     ...
     */
    private static void initInApp(Context context, int layoutIdOfEmpty, int layoutIdOfLoading, int layoutIdOfError) {
        appContext = context;
     ...
     * @return 当前页面的状态管理器
     */
    public static PageManager init(Object container, boolean isShowLoadingOrContent, Runnable retryAction) {
        PageManager pageManager = generate(container, new PageListener() {
            @Override
            public void setRetryEvent(View retryView) {
     ...
     */
    private static AlertDialog showNoNetworkDlg(Object container) {
        ...
        try {
            ...
            Activity finalActivity = (Activity) context;
